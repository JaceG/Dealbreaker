...
class Board extends React.Component {
  ...
  endMoving = () => {
    try {
      ...
      if (!boardRepository) {
        console.error('boardRepository is undefined in endMoving')
        return
      }

      if (!draggedItem) {
        console.error('draggedItem is undefined in endMoving')
        return
      }
      ...
      console.error('Error in endMoving method:', error)
