			...
			<View style={styles.centeredView}>
				<View style={styles.modalView}>
					...
					<Text style={styles.modalText}>
						<Text style={styles.itemName}>"{itemTitle}"</Text> has
						been automatically moved to your dealbreaker list
						because it's marked as a dealbreaker on the main
						profile.
					</Text>
