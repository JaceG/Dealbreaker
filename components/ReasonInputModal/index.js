...
const ReasonInputModal = ({
  ...
  useEffect(() => {
    ...
    console.log('ReasonInputModal visibility changed:', visible)
    console.log('Modal props:', { flagTitle, prevStatus, newStatus })
    ...
    if (__DEV__) {
      console.log('Running in development/simulator mode')
      console.log('Platform:', Platform.OS)
      console.log('IsPickerAvailable state:', isPickerAvailable)
      console.log('Audio enabled:', AUDIO_ENABLED)
    }
  ...
  const checkImagePickerAvailability = async () => {
    if (!IMAGE_PICKER_ENABLED || !ImagePicker) {
      console.log('Image picker is disabled or not available')
  ...
  const handleSubmit = () => {
    console.log('ReasonInputModal handleSubmit called with reason:', reason)
  ...
  const pickMedia = async () => {
    ...
    if (IMAGE_PICKER_ENABLED && ImagePicker) {
      try {
        ...
        console.error('Error using ImagePicker:', error)
        // Fall back to mock picker if something goes wrong
        useMockMediaPicker()
      }
    } else {
      console.log('Using mock media picker as fallback...')
      useMockMediaPicker()
    }
  }
