...
export const imageUtils = {
  ...
  prepareImageAttachment: (imageUri: string, fileName = null) => {
  ...
  prepareVideoAttachment: (videoUri: string, fileName = null) => {
  ...
  prepareAudioAttachment: (audioUri: string, duration = 0, fileName = null) => {
  ...
  getFileExtensionFromUri: (uri: string) => {
    if (!uri) return "jpg";
